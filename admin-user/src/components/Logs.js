...
import LastArrivalItems from './LastArrivalItems'
import realodImg from "./reload.png"
...
`
    ...
    return (
        <LastArrivalSection className='some-space' style={{ backgroundColor: "white",  width: "90%", height: "60vh", margin: "50px auto" }}>
            <h2>Last arrivals</h2>
